"""
Carregar Operadoras - Busca e carrega as tabelas de operadoras ativas e canceladas da ANS

Realiza download das tabelas de operadoras ativas e canceladas, extrai e armazena
em arquivos CSV para posterior enriquecimento dos dados consolidados.
"""
...
class CarregarOperadoras:
    """
    Carrega tabelas de operadoras ativas e canceladas da ANS
    ...
    def executar(self) -> Dict:
        ...
        logger.info(f"Carregamento concluído - Ativas: {resultado['total_ativas']}, Canceladas: {resultado['total_canceladas']}")
        
        return resultado
    
    def _carregar_ativas(self) -> tuple:
        """
    ...
    def _carregar_canceladas(self) -> tuple:
        """
    ...
    def obter_operadora(self, registro: str) -> Dict:
        ...
        if len(matches) == 0:
            ...
            logger.warning(f"Múltiplos registros encontrados para operadora - Registro: {registro}, Total: {len(matches)}")
